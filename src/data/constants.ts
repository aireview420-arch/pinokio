...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Advise brands on marketing strategy, ad campaigns, and practical AI automation to grow reach and revenue.",
      "Plan and run paid advertising across Meta and Google, from targeting and creative to budget and reporting.",
      "Build AI-powered workflows for content, campaign optimization, and client reporting.",
    ],
    skills: [
      "AI Strategy",
      "Meta Ads",
  ...
  },
  {
    ...
    company: "Pyramid Pixel",
    description: [
      "Led marketing and advertising strategy for client brands across digital channels.",
      "Managed campaign planning, creative direction, and performance analysis to drive measurable growth.",
    ],
    skills: [
      "Campaign Strategy",
